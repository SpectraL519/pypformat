...
from pformat.indentation_utility import IndentMarker

BOOLEAN_VALS = [True, False]


class TestIndentMarker:
    @pytest.mark.parametrize("character,fill", product(["", "abc"], BOOLEAN_VALS))
    def test_init_with_invalid_str_as_character(self, character: str, fill: bool):
        with pytest.raises(ValueError) as err:
            _ = IndentMarker(character, fill)
